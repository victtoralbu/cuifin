...
const FriendSelectionModal = ({ isOpen, onClose, friends, onSelect, user }) => {
                ...
                filteredFriends.length > 0 ? (
                  filteredFriends.map(friend => (
                    <button
                      ...
                      className="w-full flex items-center justify-between p-4 bg-zinc-50 dark:bg-zinc-800/50 rounded-2xl border border-zinc-100 dark:border-zinc-800 active:scale-[0.98] transition-all hover:bg-zinc-100 dark:hover:bg-zinc-800"
                    >
                      ...
                      <div className="w-8 h-8 rounded-full bg-verde/10 text-verde flex items-center justify-center">
                        <Plus size={18} />
                      </div>
                    </button>
                  ))
